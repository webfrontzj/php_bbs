...
if (!is_numeric($_POST['father_module_id'])){
    skip('son_module_add.php','error','所属父版块不能为空！');
}
...
if (empty($_POST['module_name'])){
    skip('son_module_add.php','error','子板块名称不能为空！');
}
if (mb_strlen($_POST['module_name'])>66){
    skip('son_module_add.php','error','子板块名称不能多于66个字！');
}
...
if (mb_strlen($_POST['info'])>255){
    skip('son_module_add.php','error','子版块简介不得多于255个字！');
}
